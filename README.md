...
CONDUIT_GOOGLE_SHEET_URL=https://docs.com/spreadsheets/d/1SJ5x-gyC0iWMjq6o9WMz21kBk5P8m4GtP0loaRcpNJU/edit#gid=0 \
...
| `sheetsURL`                      | URL of the google spreadsheet(copy the entire url from the address bar).                                                       | yes      | "https://docs.com/spreadsheets/d/dummy_spreadsheet_id/edit#gid=0" |
...
Ref: https://developers.com/sheets/api/limits
...
1. Google Credentials creation
    https://developers.com/workspace/guides/create-credentials

2. Google Sheets API(v4)
    https://developers.com/sheets/api/reference/rest

3. To fetch all data of a Google Sheets
    https://developers.com/sheets/api/reference/rest/v4/spreadsheets.values/batchGetByDataFilter

4. Add/Append data to Google Sheets
    https://developers.com/sheets/api/reference/rest/v4/spreadsheets.values/append